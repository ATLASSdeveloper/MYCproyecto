<script>    $(".articulos").click(function(){
...
function tipoDeArticulosLista(){
  $datos=tipoDeArticulos();
  $acumulador="";
  foreach ($datos as $d){
    $acumulador.="<option value='".$d['tipo']."'>".$d['tipo']."</option>";
  }
  return $acumulador;
}

function impresionComboBox($articulo){
  $datos=listaComboArticulos($articulo);
  $acumulador="";
  foreach ($datos as $d){
      $acumulador.=  "<div class='col-md-3'><div class='product'>
      <div class='product-img'>
